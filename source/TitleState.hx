...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		// Create image that scrolls at x2 speed based on the camera's scroll
		   var scrollBG:FlxSprite = new FlxSprite(0,0);
		   scrollBG.loadGraphic('titlemenu/bg_placeholder');
           scrollBG.scrollFactor.x = 2;
 
        // Create image that scrolls at x3 speed based on the camera's scroll
        var scrollFG:FlxSprite = new FlxSprite(0,0);
		    scrollFG.loadGraphic('titlemenu/fg_placeholder');
            scrollFG.scrollFactor.x = 2;
		//	scrollFG.FlxG.camera.scroll.add(5, 0);
	...
	//	logoBl.shader = swagShader.shader;
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('titlemenu/newgrounds'));
		add(ngSpr);
		ngSpr.visible = false;
